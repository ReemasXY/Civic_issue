...
const MobileLogin = ({
  ...
  return (
    <div className="md:hidden w-full max-w-[420px] bg-white rounded-[22px] border border-[#E5EBE8] shadow-[0_1px_2px_rgba(20,35,59,0.04),0_20px_44px_-16px_rgba(20,35,59,0.16)] p-6 sm:p-7">
      ...
      <div className="relative flex rounded-full bg-[#F1F4F3] p-1 mb-6">
        ...
        <button
          ...
          className={`relative z-10 flex-1 cursor-pointer py-2.5 text-[13px] font-medium transition-colors duration-200 ${
          ...
          <>
            ...
            <p className="text-center text-[12.5px] text-[#687585] mt-5">
              ...
              <button
                type="button"
                onClick={() => setIsSignUp(false)}
                className="cursor-pointer font-semibold text-[#1F8A70]"
              >
                Sign In
              </button>
            </p>
