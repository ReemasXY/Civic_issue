        ...
        >
          ...
          >
            ...
            <button
              ...
              className="mt-6 cursor-pointer rounded-full border border-white/80 px-8 py-2.5 text-[12.5px] font-semibold uppercase tracking-wide transition-colors hover:bg-white hover:text-[#14233B]"
            >
              Sign In
            </button>
          </div>
